...
_STRINGS: Dict[str, Dict[str, str]] = {
    "de": {
        ...
        "mkv.video_dir": "Video-Ordner",
        "mkv.subtitle_dir": "Untertitel-Ordner",
        "mkv.output_dir": "Zielordner",
        ...
        "mkv.no_output_dir": "Bitte geben Sie einen Zielordner an.",
        "mkv.batch_mode": "Batch-Modus (Dateien nach Name matchen)",
        "mkv.batch_mode_desc": "Wählen Sie einen Ordner mit Videos und einen mit Untertiteln. Videos und Untertitel werden anhand ihres Namens (z.B. 'S01E01') automatisch zusammengeführt.",
    ...
    "mkv.output_file": "Output File",
        "mkv.video_dir": "Video Directory",
        "mkv.subtitle_dir": "Subtitle Directory",
        "mkv.output_dir": "Output Directory",
    "mkv.browse": "Browse...",
    ...
    "mkv.no_output_file": "Please specify an output file.",
        "mkv.no_output_dir": "Please specify an output directory.",
        "mkv.batch_mode": "Batch Mode (match files by name)",
        "mkv.batch_mode_desc": "Select a folder with videos and one with subtitles. Videos and subtitles will be merged automatically based on their names (e.g., 'S01E01').",
